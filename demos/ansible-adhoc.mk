...
# Let's build a bridge to expose adhoc ansible[1]. This declares a
# top-level target ansible.adhoc that takes one parameter, the
# name of the ansible module to call.  The prereq target
# Dockerfile.build/Ansible ensures the container described
# above is ready.  This target runs on the host, so we don't have
# access to ansible here, and so it dispatches to a private target
# at self.ansible.adhoc/<module_name>.
#
# [1]
