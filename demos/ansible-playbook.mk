...
#
# ansible-playbook.mk: Passing embedded-data into an embedded-container.
#
...
define Dockerfile.AnsiblePlaybook
...
__main__: Dockerfile.build/AnsiblePlaybook
	...
	img=compose.mk:AnsiblePlaybook ${make} \
