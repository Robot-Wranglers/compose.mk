...
#
# platform.mk:
#   A way to organize platform lifecycle automation with `compose.mk`. We
#   use namespace-style dispatch here to run commands in docker-compose
#   managed containers, and use `compose.mk` workflows to to describe
#   data-flow.
#
