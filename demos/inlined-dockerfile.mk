...
test.3.docker.dispatch:
	$(call log.test_case,docker.dispatch requires image prefix and does target-dispatch)
...
test.7.docker.lambda.target:
	$(call log.test_case, docker.lambda builds/runs a def in 1 step w/o tag references)
