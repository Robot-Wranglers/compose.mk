...
widget.choice:
	...
	${make} io.selector/self.tasks.list,flux.and

# Helper to return the targets matching "task.*" pattern
self.tasks.list:; ${make} mk.parse.local| grep ^task | ${stream.nl.to.space}

# Fake tasks to populate the chooser.. 
# these will just print their own name, but could do anything
