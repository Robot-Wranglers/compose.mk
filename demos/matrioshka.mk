...
#
#   See more discussion here: https://robot-wranglers.github.io/compose.mk/matrioshka
#
...
services:
  alice: &base
    ...
    build:
      ...
      dockerfile_inline: |
        FROM docker:dind
        RUN apk add --update --update --no-cache coreutils alpine-sdk bash procps-ng
        COPY . /app
...
$(eval $(call compose.import.def,  inlined.services,  TRUE))

# Top level entrypoint, we just kick off provisioning and dispatch stages.
demo.matrioshka: demo.build demo.dispatch demo.summary
...
# was already created by `compose.import.def` to dispatch the 
