...
demo.dispatch: stage.enter/RUN
	@# Each dispatch carries the provisioning target its service was built
	@# with, since that value is part of the spec dispatch checks first.
	BUILD_TARGET=alice.provision ${make} alice.dispatch/internal_task
	BUILD_TARGET=bob.provision ${make} bob.dispatch/internal_task
...
internal_task:
	...
	${jb} host=`hostname` timestamp="`date`" | ${make} stage.push/RUN
