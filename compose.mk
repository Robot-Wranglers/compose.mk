...
# stream.push.word: push a RAW word read from stdin onto the default stack.  This is
# the stdin-input counterpart of `io.stack.pop.word` (which emits a raw word).  `jq -Rs .`
...
# the same reason $0/$i below work.)
